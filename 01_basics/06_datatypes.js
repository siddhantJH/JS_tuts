...
// const score=100  //js is dynamically types language, in typescript const:Int was given 
...
// //non primite(reference types): Arrays,Objects,Functions . Their datatypes are of function object  
...
// //Heap (non-primitive):reference is gives changes made on original value. (functions , object )

let value="Siddhant"
let value2=String("Siddhant")
